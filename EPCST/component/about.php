...
<head>
 ...
 <ul class="navigation">
            <li onclick="changeBackgroundHistory()"><a href="#">History</a></li>
            <li onclick="changeBackgroundMission()"><a href="#">Mission</a></li>
            <li onclick="changeBackgroundVision()"><a href="#">Vision</a></li>
            <li onclick="changeBackgroundPhilosophy()"><a href="#">Philosophy and Values</a></li>
            <li onclick="changeBackgroundFacilities()"><a href="#">Facilities</a></li>
            <li onclick="changeBackgroundDepartments()"><a href="#">Departments</a></li>
        </ul>
</div>
    <script>
